...
def showHighScoreScreen():
    ...
    while True:
        ...
        y = 30
        while counter < 30:
            SCREEN.blit(IMAGES['letters'][0], (56,y))
            SCREEN.blit(IMAGES['letters'][1], (56 + 27,y))
            SCREEN.blit(IMAGES['letters'][2], (56 + 27 + 27,y))

            SCREEN.blit(IMAGES['numbers'][1], (56 + 27 + 27 + 27 + 27,y))
            SCREEN.blit(IMAGES['numbers'][2], (56 + 27 + 27 + 27 + 27 + 27,y))
            SCREEN.blit(IMAGES['numbers'][3], (56 + 27 + 27 + 27 + 27 + 27 + 27,y))
